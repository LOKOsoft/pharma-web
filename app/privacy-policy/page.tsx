...
export const metadata: Metadata = {
  ...
  description:
    "Read the 9Doctor Privacy Policy to understand how we collect, use, and protect your data and your patients' data.",
...
const sections = [
  {
    ...
    body: [
      ...
      "When your organization uses 9Doctor, we process protected health information (PHI) and other patient data on your behalf as a service provider, strictly in accordance with your instructions and applicable healthcare privacy laws.",
    ],
  },
  {
    heading: "2. How We Use Information",
    body: [
      "We use collected information to provide, maintain, and improve the 9Doctor platform, to communicate with you about your account, and to provide customer support.",
  ...
  },
  {
    ...
    body: [
      "9Doctor employs industry-standard security measures including encryption in transit and at rest, role-based access controls, regular security audits, and continuous monitoring.",
...
export default function PrivacyPolicyPage() {
  return (
    <LegalContent
      title="Privacy Policy"
      updated="July 1, 2026"
      intro="This Privacy Policy explains how 9Doctor collects, uses, and safeguards information when you use our website and platform. We built 9Doctor to handle sensitive healthcare data responsibly, and this policy reflects that commitment."
      sections={sections}
    />
  );
}
